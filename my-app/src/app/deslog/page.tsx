...
export default function Deslog({ user }: DeslogProps) {
    ...
    return (
        ...
        <div className="bg-gray-200 flex justify-center">
            ...
            {/*<img src={user.profile_image} className="absolute top-16 left-28 transform -translate-x-1/2 rounded-full h-36 w-36" alt={user.name} />*/}
            <div className="border border-black ">
                ...
                <div className="flex">
                    ...
                    <p className='w-full mt-2 ml-2 text-sm'>{user.name} · 17/04/2024, ás 21:42 · João Frango · Surf</p>
                </div>
                ...
                <div className="flex">
                    <img src="/morty.png" className=" h-10 w-10 bg-[#A4FED3] rounded-full" alt="" />
                    <p className='w-full mt-2 ml-2 text-sm'>{user.name} · 15/04/2024, ás 21:42 · Rick · Viagem Interdimensional</p>
                </div>
                <div className="w-full px-2 pt-5">
                    <p className="text-justify font-sans text-base">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit magnam animi hic quos non similique magni earum consequuntur corporis facilis consectetur, repellendus eaque ab. Pariatur repudiandae minima culpa quas vitae?
